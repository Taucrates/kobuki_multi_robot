/**
 * @Author: Toni Tauler & Esau Ortiz Toribio
 * @File: multi_robot_master_v2.cpp
...
{
  ros::init(argc, argv, "multi_robot_master_v2");
  ros::NodeHandle nh;
  ...
  nh.getParam("/multi_robot_master_v2/global_goals_path_file", global_goals_path_file);
...
void getGlobalGoals(std::vector<std::vector<float>>* global_goals, const std::string& global_goals_path_file){
    ...
    {
        ROS_INFO("Get global goals/while");
